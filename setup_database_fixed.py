#!/usr/bin/env python3
"""
Database setup script for EduBridge with better error handling
...
def check_mysql_connection():
    ...
    try:
        ...
        print("   - Press Win + R, type 'services.msc' and press Enter")
        print("   - Find 'MySQL84' or 'MySQL' service")
        print("   - Right-click and select 'Start'")
        print("   - Or run as Administrator: net start MySQL84")
...
def main():
    ...
    if not check_mysql_connection():
        ...
        print("Please start MySQL service and try again.")
        return
